...
$(function () {
    key_lft_num = 0
    $('.btn_btm').click(function () {
        key_lft_num++
        var key_lft_sum = $('.key_lft_view li').size()

        if (key_lft_num == key_lft_sum - 4) {
            key_lft_num = key_lft_num - 1
        }
        $('.key_lft ul').stop().animate({ top: -289 * key_lft_num })
    })
