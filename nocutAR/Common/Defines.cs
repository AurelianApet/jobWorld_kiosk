...
namespace jobworld.Common
{
    ...
    public class Defines
    {
        ...
        public static string ABS_IMAGE_PATH
        {
            get { return ConfigurationManager.AppSettings["ABS_IMAGE_PATH"]; }
        }

        public static string IMAGE_PATH
        {
            get { return ConfigurationManager.AppSettings["IMAGE_PATH"]; }
        }

        public static string CON_PATH
        {
            get { return ConfigurationManager.AppSettings["CON_PATH"]; }
        }
